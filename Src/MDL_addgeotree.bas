...
'    crSkt og
    ...
    For i = 0 To UBound(arr)
        ...
        og.Name = arr(i)
    Next
    Set subcolls = colls.item(arr(0)).HybridBodies
    For i = 1 To 3
        Set og = subcolls.Add(): og.Name = "FA_0" & i
    Next
    Set subcolls = colls.item(arr(3)).HybridBodies
    For i = 1 To 3
        Set og = subcolls.Add(): og.Name = "TR_0" & i
    Next
    Set subcolls = colls.item(arr(4)).HybridBodies
    For i = 1 To 3
